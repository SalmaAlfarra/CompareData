...
<body>
    <div class="container">
        ...
        <div class="buttons-container">
            ...
            <a href="{{ route('excel.downloadData') }}" class="download-btn"><i class="fas fa-download"></i> تحميل البيانات التي تم معالجتها</a>
            <a href="{{ route('excel.missigData') }}" class="download-btn"><i class="fas fa-eye"></i> عرض البيانات المفقودة</a>
        </div>
